...
## 🎁 Free: 9 SQL Checks + RLS Cheatsheet (Get it in your inbox)

**Want the `audit/rls-audit.sql` (9 queries) + `audit/two-user-probe.sql` + the RLS Test Matrix as a copy-pasteable markdown file — without digging through the repo?**

Drop your email, I'll send them instantly:

> **📧 [Get the free RLS toolkit →](https://cengokurtoglu.gumroad.com/l/supabase-rls-audit-kit?utm_source=github&utm_medium=readme_lead&utm_campaign=rls_kit_launch&utm_content=free_toolkit)**

*No spam. One email with the files. Unsubscribe anytime. Also adds you to the Gumroad "follow" list for updates.*
...
a security, compliance, or launch-outcome guarantee.
